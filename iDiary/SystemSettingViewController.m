...
#define TableViewBKColor 0xefecec
#define SeperatorColor  0xd7d3d3
...
{
    [super viewDidLoad];
    self.view.backgroundColor = HEXCOLOR(TableViewBKColor, 1);
    mTableView.rowHeight = 50;
    mTableView.backgroundColor = [UIColor clearColor];
    mTableView.backgroundView = nil;
    mTableView.separatorColor = HEXCOLOR(SeperatorColor, 1);
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    [tableView deselectRowAtIndexPath:indexPath animated:YES];
     ...
     else if ([indexPath section] == 2 && [indexPath row] == 1)
     {
         ...
         [social sendFeedback:nil body:nil];
     }
}
